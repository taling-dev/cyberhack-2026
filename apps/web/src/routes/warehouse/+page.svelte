  ...
  <section class="overflow-hidden rounded-lg border border-slate-200 bg-white shadow-sm">
    <div class="flex items-center justify-between border-b border-slate-200 bg-white px-4 py-3">
      <div>
        ...
        <p class="mt-1 text-xs text-slate-500">QC-approved lots ready for warehouse slotting.</p>
      </div>
      <span class="rounded-md bg-purple-100 px-2.5 py-1 text-xs font-semibold text-purple-700">{lots.length} pending</span>
    </div>
