...
SARI is a cloud-portable enterprise operations platform running on Kubernetes (GKE Standard). All application services are containerized and deployed via Helm charts; no Google-native application services are used for core logic.
